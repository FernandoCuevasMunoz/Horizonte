...
const benefits = [
  ...
  { icon: BadgeCheck, title: 'Gestión integral', text: 'Nos encargamos de todo.' },
];
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 w-full max-w-[1510px] mx-auto px-[5.5vw] pt-[170px] md:pt-[150px]">
        <div className="max-w-[620px]">
          <h1 className="m-0 text-[#0c3d34] text-[clamp(3rem,5.2vw,5.9rem)] font-black leading-[1.04] tracking-normal">
            Encuentra tu
            <span className="block">próximo hogar</span>
      ...
      >
        ...
        <motion.button type="submit" className="inline-flex items-center justify-center gap-[10px] min-w-[160px] min-h-[50px] border-0 rounded-[7px] bg-forest text-white px-5 font-extrabold shadow-[0_12px_24px_rgba(15,74,61,0.16)] md:col-span-full lg:col-auto cursor-pointer" whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.96 }}>
